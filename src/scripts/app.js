...
function renderParticipantsList() {
    ...
    listofParticipants.forEach(participant => {
        ...
        pullParticipant.innerHTML += `<li id="${participant.replace(/\s|["']/g, '')}"><span>${participant}</span><i class="fa fa-user-minus" id="btn-delete"></i><i class="fa fa-edit" id="btn-edit"></i></li>`;
    })
}
